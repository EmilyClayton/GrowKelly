...
try: 
    spritesheet = pygame.image.load(os.path.join(folder, "Kid Kellys.bmp"))
except: 
...
for nbr in range(1,4,1): # first line contains 4 pictures of lions
   lions.append(spritesheet.subsurface((70*(nbr-1),10,200,200)))
for nbr in range(4,7,1): # second line contains 2 pictures of lions
   lions.append(spritesheet.subsurface((70*(nbr-4),200,400,400)))
for nbr in range(7,10,1): # second line contains 2 pictures of lions
   lions.append(spritesheet.subsurface((70*(nbr-7),400,600,600)))
# for nbr in range(10,13,1): # second line contains 2 pictures of lions
#    lions.append(spritesheet.subsurface((20*(nbr-10),0,100,160)))
# for nbr in range(13,15,1): # second line contains 2 pictures of lions
#    lions.append(spritesheet.subsurface((20*(nbr-13),0,100,160)))
print("len:",len(lions))
...
for nbr in range(len(lions)):
    screen.blit(lions[nbr], (nbr*10, 0))  #blit the ball surface on the screen (on top of background)
